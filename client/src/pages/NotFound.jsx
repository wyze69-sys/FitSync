  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-bg text-text px-4 text-center">
      <div className="space-y-4 max-w-sm">
        <Compass className="h-10 w-10 text-primary mx-auto" aria-hidden="true" />
        ...
        <Link
          to={homePath}
          className="inline-block px-5 py-2 bg-primary text-white rounded-sm text-xs font-medium uppercase tracking-widest transition-all"
        >
          Back to safety
        </Link>
      </div>
